...
for (const cours of coursesArray) {
    let divElemetns = document.createElement('div');
    let h2 = document.createElement('h2');
    h2.innerText = cours.title

    let divMont = document.createElement('div');
    divMont.innerText = cours.monthDuration
    let divHour = document.createElement('div');
    divHour.innerText = cours.hourDuration

    let ulElements = document.createElement('ul');
    for (const ulElement of cours.modules) {
        let li = document.createElement('li');
        li.innerText = ulElement
        ulElements.appendChild(li)
    }

    divElemetns.append(h2,divMont,divHour,ulElements)
    document.body.append(divElemetns)
